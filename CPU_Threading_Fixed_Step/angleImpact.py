...
def angle_to_impact(theta, r0=10, M=1.0):
    """
    Compute the impact parameter b for a light ray emitted at angle theta
    around a Schwarzschild black hole of mass M.
    ...
    r0 : float, optional
        Initial radial coordinate of the camera.
